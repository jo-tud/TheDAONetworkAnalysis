...
#
# From: http://gopalakrishna.palem.in/iGraphExport.html#GexfExport
saveAsGEXF = function(g, filepath="converted_graph.gexf")
{
  ...
  output <- write.gexf(nodes, edges, 
                       ...
                       edgesAtt = edgesAtt,
                       nodesAtt = nodesAtt,
                       meta=c(list(creator="JP", description="igraph -> gexf converted file", keywords="igraph, gexf, R, rgexf")))
